...
console.log(showComputer(25));
console.log(showComputer(41));
console.log(showComputer(1048));
...
function showCoincidence(num1, num2) {
    let result = [];
...
console.log(showCoincidence(arr, array));
